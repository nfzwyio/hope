...
![图6.1 	在无线主机和服务器之间的六个链路层跳](/net_img/601.png) 
...
![图6.10 节点1、节点2、节点3在第一个时隙碰撞。节点2在第四个时隙成功，节点1在第8个时隙成功，节点3在第9个时隙成功](/net_img/610.png) 
...
![图6.11 纯ALOHA中的干扰传输](/net_img/611.png) 
...
![图6.12 传输碰撞的两个CSMA节点的时空图](/net_img/612.png) 
...
![图6.15 通过四个交换机连接的机构网络 ](/net_img/615.png) 
...
![图6.16 每个连接到局域网的接口都有唯一的MAC地址 ](/net_img/616.png) 
...
![图6.17 局域网中的每个接口都有一个IP地址和一个MAC地址](/net_img/617.png) 
...
![图6.24 交换机、路由器和主机中的数据包处理 ](/net_img/624.png) 
...
![图6.25 配置了两个VLAN的单个交换机](/net_img/625.png) 
...
![图6.26 通过两个VLAN连接两台VLAN交换机:(a)两根线缆(b) 中继线 ](/net_img/626.png) 
...
![图6.27  原始以太网帧(上)，802.1 q加标以太网VLAN帧(下)](/net_img/627.png) 
...
![图6.28 MPLS头:位于链路层头和网络层头之间 ](/net_img/628.png) 
...
![图6.29 增强的MPLS转发 ](/net_img/629.png) 
...
![图6.30 分层拓扑结构的数据中心网络](/net_img/630.png) 
...
![图6.31 高度互联的数据网络拓扑结构 ](/net_img/631.png) 
...
![图6.32 Web页面请求:网络设置和操作 ](/net_img/632.png) 
